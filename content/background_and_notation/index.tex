...
For the statistical analysis of the report, we define the MRR score $a$ to be significantly higher than the MRR score $b$ if $a > b + (1-b) \times 0.1$. Conversely, we define the MRR score $a$ to be significantly lower than the MRR score $b$ if $a < b \times 0.9$.
